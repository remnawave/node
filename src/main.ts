...
async function bootstrap(): Promise<void> {
    const internalApiSocket = process.env.INTERNAL_API_SOCKET!;
    if (fs.existsSync(internalApiSocket)) {
        fs.unlinkSync(internalApiSocket);
    }
    ...
    const internalServer = internalApp.listen(internalApiSocket);
