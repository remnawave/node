...
export const REST_API = {
    ...
    FEDARISHA: {
        PROVISION_USER: `${ROOT}/${CONTROLLERS.FEDARISHA_CONTROLLER}/${CONTROLLERS.FEDARISHA_ROUTES.PROVISION_USER}`,
        REVOKE_USER: `${ROOT}/${CONTROLLERS.FEDARISHA_CONTROLLER}/${CONTROLLERS.FEDARISHA_ROUTES.REVOKE_USER}`,
        PROBE_USER: `${ROOT}/${CONTROLLERS.FEDARISHA_CONTROLLER}/${CONTROLLERS.FEDARISHA_ROUTES.PROBE_USER}`,
    },
    STATS: {
